...
class MyanFont
{
    ...
    protected static function ZgOrUni($text)
    {
        ...
        if (preg_match($uniPattern, $text)) return self::UNICODE; elseif (preg_match($zgPattern, $text)) return self::ZAWGYI; elseif (preg_match($regexMM, $text)) return self::MYANMAR;
        else
